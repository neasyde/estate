...
object SettingsKeys {
    ...
    val RATE_CNY = doublePreferencesKey("exchange_rate_cny")
    val RATE_KZT = doublePreferencesKey("exchange_rate_kzt")
    ...
    val AUTO_SWITCH_THEME = booleanPreferencesKey("auto_switch_theme")
    val AUTO_SWITCH_START = intPreferencesKey("auto_switch_start")
    val AUTO_SWITCH_END = intPreferencesKey("auto_switch_end")
    val CUSTOM_ACCENT_COLOR = intPreferencesKey("custom_accent_color")
    val DASHBOARD_LAYOUT = stringPreferencesKey("dashboard_layout")
    val DASHBOARD_BLOCKS = stringPreferencesKey("dashboard_blocks")
    val DASHBOARD_QUICK_ACTIONS = stringPreferencesKey("dashboard_quick_actions")
